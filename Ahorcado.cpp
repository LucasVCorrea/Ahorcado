...
void Ahorcado::elegirTema(){
	...
	switch(this->temaElegido){
		...
		case '3':
			...
			break;
		case '4':
			if(this->generaRandomNumber() > 0 && this->generaRandomNumber() <= 10){
			...
			else if(this->generaRandomNumber() > 10 && this->generaRandomNumber() < 15){
...
void Ahorcado::mostrarTemas(){
	string listaDeTemas[] = {"Personajes de marvel", "Cantantes/Bandas","Champs del lol","random"};
